...
* @Repository path:		$HeadURL: https://svn.code.sf.net/p/xoops/svn/XoopsModules/smallworld/trunk/smallworld/admin/moduleinfo.php $
* @Last committed:		$Revision: 9412 $
* @Last changed by:		$Author: beckmi $
* @Last changed date:	$Date: 2012-04-30 00:07:58 -0400 (Mon, 30 Apr 2012) $
