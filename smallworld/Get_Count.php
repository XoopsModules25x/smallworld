...
* @Repository path:		$HeadURL: https://svn.code.sf.net/p/xoops/svn/XoopsModules/smallworld/trunk/smallworld/Get_Count.php $
* @Last committed:		$Revision: 9712 $
* @Last changed by:		$Author: djculex $
* @Last changed date:	$Date: 2012-06-25 10:00:46 -0400 (Mon, 25 Jun 2012) $
