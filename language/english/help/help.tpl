...
<div id="help-template" class="outer">
    ...
    <p class="even">This module is ....
    Inspired by the Srinivas Tamada tutorials on Facebook scripting.<br>
    Smallworld features like/dislike, bookmarking, wall system, image gallery, and is using XOOPS Instant Messenger (XIM) module 
    if installed. The admin side allows deleting users, banning users based on time. A countdown is shown on user side to 
    when it's back. And many more features.
    <br> <br>
    </p>
    ...
    <p class="even">
        No special measures necessary, follow the standard installation process to
    ...
    <p class="even">
        ...
        <a href="https://xoops.gitbook.io/xoops-operations-guide/" target="_blank">Chapter 2.8 of our XOOPS Operations Manual</a>
        <br><br>
    </p>
    ...
    <p class="even">
        Translations are on <a href="https://www.transifex.com/xoops/" target="_blank">Transifex</a> and in our <a href="https://github.com/XoopsLanguages/" target="_blank">XOOPS Languages Repository on GitHub</a>.
    </p>
