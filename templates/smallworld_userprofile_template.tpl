...
<div id="userbio"><span id="smallworld_capname" class="smallworld_capital"><{$username}></span> <{$smarty.const._SMALLWORLD_AKA}> <{$realname}>, <{$smarty.const._SMALLWORLD_BORN}> <span id="smallworldBday"><a href="javascript:void(0);" id="smallworldBdayLink"><{$birthday}></a></span> (<{$age}>
