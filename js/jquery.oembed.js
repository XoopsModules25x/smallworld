...
(function(xoops_smallworld) {
    ...
    xoops_smallworld.fn.oembed.getOEmbedProvider = function(url) {
        for (var i = 0; i < xoops_smallworld.fn.oembed.providers.length; i++) {
            for (var j = 0, l =xoops_smallworld.fn.oembed.providers[i].urlschemes.length; j < l; j++) {
                ...
                if (url.match(regExp) !== null) return xoops_smallworld.fn.oembed.providers[i];
            }
        }
        return null;
    };
    ...
    new xoops_smallworld.fn.oembed.OEmbedProvider("wistia", "video", ["wistia.com/m/.+", "wistia.com/embed/.+","wi.st/m/.+","wi.st/embed/.+"], 'http://fast.wistia.com/oembed', {useYQL:'json'}), 
    ...
    new xoops_smallworld.fn.oembed.OEmbedProvider("Soundcloud", "rich", ["soundcloud.com/.+","snd.sc/.+"], "http://soundcloud.com/oembed",{format:'js'}),
    ...
    {yql:{xpath:"json", from:'json'
		...
		new xoops_smallworld.fn.oembed.OEmbedProvider("flickr", "photo", ["flickr\\.com/photos/.+"], "http://flickr.com/services/oembed",{callbackparameter:'jsoncallback'}),
    ...
    //new xoops_smallworld.fn.oembed.OEmbedProvider("gmep", "rich", ["gmep.imeducate.com/.*"], "http://gmep.imeducate.com/oembed"),
    ...
    // Culex added pages      
    // Xoops news
    new xoops_smallworld.fn.oembed.OEmbedProvider("xoopsnews", "rich", ["xoops.org/modules/news/article.php.storyid.\\d+"], null,
      {yql:{xpath:'//div[@class="wox_news_item wox_news_single_item"]', from: 'htmlstring'
          , datareturn:function(results){
              if(!results.result) return false;
              return "<div class='xo-content'>"+results.result+"</div>";
              }
          }
      }),    
    
    // Audio files to yahoo player
    //.+/([0-9]+)([a-zA-Z]+)(.wav|.mp3|.mp4)
