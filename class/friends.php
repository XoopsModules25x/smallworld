...
* @Repository path:        $HeadURL: https://svn.code.sf.net/p/xoops/svn/XoopsModules/smallworld/trunk/smallworld/class/friends.php $
* @Last committed:        $Revision: 8907 $
* @Last changed by:        $Author: djculex $
* @Last changed date:    $Date: 2012-02-07 22:54:48 -0500 (Tue, 07 Feb 2012) $
